...
<body>
    ...
    <div class="wrappage">
        ...
        <div class="page-heading">
            ...
            <ul class="nav nav-tabs nav-justified nav-filter">
        ...
        <div class="wrap-filter">
            <div class="wrap-filter-box wrap-filter-number">
                <ul class="pagination">
                    ...
                    <li><a href="">5</a></li>
                    <li><a href="">6</a></li>
                    <li><span>Showing 1-12 of 30 products</span></li>
                </ul>
            </div>
            <div class="wrap-filter-box text-center">
                <a href="#"><span class="icon-grid-img"></span></a>
            </div>
            <div class="wrap-filter-box text-center"><a href="#" class="filter-title"><i class="icon-equalizer"></i></a></div>
            <div class="wrap-filter-box text-center">
                <a href="#"><span class="icon-list-img"></span></a>
            </div>
                        ...
                        <div class="row product-list">
                            <div class="col-xs-6 col-sm-4 col-md-4 col-lg-3 product-item">
                                <div class="product-img">
                                    <a href="#" class="hover-images effect"><img src="img/products/hoodie.jpg" alt="photo" class="img-reponsive"></a>
                                    ...
                                    <div class="ribbon-price"><span>£240</span></div>
                                    <div class="ribbon-sale ver2"><span>sale</span></div>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-4 col-md-4 col-lg-3 product-item">
                                <div class="product-img">
                                    <a href="#" class="hover-images effect"><img src="img/products/hat.jpg" alt="photo" class="img-reponsive"></a>
                                    <div class="product-info">
                                        <div class="product-price">£240</div>
                                        <h3 class="product-title"><a href="#">Merino Fancy Pullover</a></h3>
                                        <a href="#" class="btn-quickview"><i class="icon-eye f-20"></i></a>
                            ...
                            <div class="col-xs-6 col-sm-4 col-md-4 col-lg-3 product-item">
                                <div class="product-img">
                                    <a href="#" class="hover-images effect"><img src="img/products/sneaker.jpg" alt="photo" class="img-reponsive"></a>
                                    <div class="product-info">
                                        <div class="product-price">£240</div>
                                        <h3 class="product-title"><a href="#">Merino Fancy Pullover</a></h3>
                                        <a href="#" class="btn-quickview"><i class="icon-eye f-20"></i></a>
            ...
            <div class="quick-modal show">
                <div id="quickview-content">
                    <div class="single-product-detail">
                        <div class="product-images js-quickview">
                            <img src="img/products/shortshirt.jpg" alt="photo" class="img-reponsive"><img src="img/products/long.jpg" alt="photo" class="img-reponsive">
                            <img src="img/products/highheels.jpg" alt="photo" class="img-reponsive">
                        </div>
                        <div class="single-product-info">
                            ...
                            <h3 class="product-title"><a href="#">Simple Product</a></h3>
                            ...
                            <a href="#" class="quick-more v2">More details<span class="icon-arr"></span></a>
                        </div>
                    </div>
                </div>
            </div>
