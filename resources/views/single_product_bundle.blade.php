...
<body>
    ...
    <div class="wrappage">
        ...
        <div class="container">
            <div class="single-product-detail product-bundle single-product-space v2">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-7 col-md-6">
                        <div class="single-product-info">
                            ...
                            <h3 class="product-title"><a href="#">Product with bundle</a></h3>
                            ...
                            <div class="action v4">
                                ...
                                <a href="#" class="link-ver1 add-cart">Add To Cart</a>
                                <a href="#" class="link-ver1 wish"><i class="icon-heart f-15"></i></a>
                                <div class="clearfix"></div>
                            </div>
                            <div class="bundle">
                                <span>Buy this bundle and get off to 10%</span>
                                <p>Cestibulum tortor quam, feugiat vitae, ultricies egetsi amet, ante. Donec eu libero sit amet quam egestas semper. </p>
                                <div class="product-bundle-list">
                                    <div class="product-bundle-item">
                                        ...
                                        <div class="product-info-ver2">
                                            <h3 class="product-title"><a href="#">This product: Short Sleeved Hoodie <br> With Step Hem</a></h3>
                                            <div class="product-price">
                                                <span class="old">$22.2</span>
                                                <span>$30.00</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="product-bundle-item active">
                                        <div class="product-images ">
                                            <a href="#" class="hover-images effect"><img src="img/products/long.jpg" alt="photo" class="img-reponsive"></a>
                                        </div>
                                        <div class="product-info-ver2">
                                            <h3 class="product-title"><a href="#">Pink Leather Watch </a></h3>
                                            <div class="product-price">
                                                <span class="old">$22.2</span>
                                                <span>$30.00</span>
                                            </div>
                                    ...
                                    <div class="product-bundle-item active">
                                        ...
                                        <div class="product-info-ver2">
                                            <h3 class="product-title"><a href="#">Short Sleeved Hoodie With Step Hem</a></h3>
                                            <div class="product-price">
                                                <span class="old">$22.2</span>
                                                <span>$30.00</span>
                                            </div>
                                ...
                                <div class="action v5">
                                    <a href="#" class="add-cart">Add Bundle To Cart</a>
                                </div>
                            </div>
            ...
            <div class="single-product-tab">
                ...
                <div class="tab-content">
                    <div id="desc" class="tab-pane fade in active">
                        <div class="img">
                            <a href="#" class=""><img src="img/casual-male-outfit.jpg" alt="photo" class="img-reponsive"></a>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-md-6">
                                <p class="space-margin-top-50">Efficiently benchmark granular supply chains through bleeding-edge infomediaries. Dramatically recaptiualize intuitive core competencies with timely systems. Credibly procrastinate process-centric benefits and compelling meta-services. Credibly engineer intuitive vortals with functional total linkage. Enthusiastically extend maintainable infrastructures</p>
                            </div>
                            <div class="col-xs-12 col-md-6">
                                <p class="space-margin-top-50">Progressively unleash market positioning markets and impactful functionalities. Proactively optimize market-driven action items rather than magnetic manufactured products. Intrinsicly orchestrate magnetic innovation for cross-unit technology. Compellingly disintermediate team driven e-services vis-a-vis flexible process improvements.</p>
                            </div>
                        </div>
                    </div>
                    <div id="info" class="tab-pane fade in">
                        <p>Constructed in cotton sweat fabric, this lovely piece, lacus eu mattis auctor, dolor lectus venenatis nulla, at tristique eros sem vel ante. Sed leo enim, iaculis ornare tristique non, vulputate sit amet ante. Mauris placerat eleifend leo.</p>
                    </div>
            ...
            <div class="container container-42">
                ...
                <div class="owl-carousel owl-theme js-owl-product">
                    <div class="product-item">
                        <div class="product-images">
                            <a href="#" class="hover-images effect"><img src="img/products/highheels.jpg" alt="products" class=" hover-images img-reponsive"></a>
